...
namespace CoreFundamentalsShop.Models
{
    ...
    {
        private readonly CoreFundamentalsShopDbContext _bethanysPieShopDbContext;

        public string? ShoppingCartId { get; set; }

        public List<ShoppingCartItem> ShoppingCartItems { get; set; } = default!;

        private ShoppingCart(CoreFundamentalsShopDbContext bethanysPieShopDbContext)
        {
        ...
        public static ShoppingCart GetCart(IServiceProvider services)
        {
            ...
            CoreFundamentalsShopDbContext context = services.GetService<CoreFundamentalsShopDbContext>() ?? throw new Exception("Error initializing");
